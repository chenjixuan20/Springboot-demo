...
//        List<List<String>> lists = readCSV("data/exp1/Horse/Horse.csv");
        List<List<String>> lists = readCSV("data/exp6/FLI 300K 11.csv");
...
//        List<List<String>> lists = readCSV("data/exp3/data/varying_R/14/FLI 300 11.csv");
        ...
        //只保留93w条数据
        List<List<String>> new_list = getSubList(lists,0,100000, true);
...
//        result.add(0, new_title);
       ...
       //写文件
        writeCSV(new_list, "data/exp6/FLI 100K.csv");
    }
