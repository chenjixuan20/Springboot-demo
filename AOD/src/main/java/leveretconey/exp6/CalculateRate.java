...
public class CalculateRate {
    public static void main(String[] args) {
        DataFrame data= DataFrame.fromCsv("data/exp7/FLI 400K 11.csv");
...
//        }
        ...
        for (LexicographicalOrderDependency aod2 : aods2) {
            LexicographicalOrderDependency od = LexicographicalOrderDependency.fromString(aod2.toString());
            ImprovedTwoSideSortedPartition isp = new ImprovedTwoSideSortedPartition(subData,od);
            ValidationResultWithAccurateBound er = isp.validateForALODWithG1();
//            System.out.println("aod: " + aod2.toString());
//            System.out.println("error rate: " + er.errorRate);
            if(map.get(aod2.toString()) != null){
                double error = map.get(aod2.toString());
