...
//    }
    ...
    public ODTree(int countAttribute) {
        ...
        root=new ODTreeNode(AttributeAndDirection.getInstance(0,AttributeAndDirection.UP)
...
//        }
        ...
        public ODTreeNode(AttributeAndDirection attribute , ODTreeNodeStatus status){
            this.parent = null;
            this.status = status;
